    ...
    <div>
                    ...
                    <div class="tw-mt-2 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4">
                        <div v-for="permission in availablePermissions" :key="permission">
                            <label class="tw-flex tw-items-center">
                                ...
                                <span class="tw-ml-2 tw-text-sm tw-capitalize tw-text-gray-600">{{ permission }}</span>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div v-if="$page.props.jetstream.flash.token" class="tw-mt-4 tw-bg-gray-100 tw-px-4 tw-py-2 tw-rounded tw-font-mono tw-text-sm tw-text-gray-500">
