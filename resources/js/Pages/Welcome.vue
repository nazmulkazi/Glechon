...
<template>
    ...
    <div class="tw-relative tw-flex items-top tw-justify-center tw-min-h-screen tw-bg-gray-100 dark:tw-bg-gray-900 sm:tw-items-center sm:tw-pt-0">
        <div v-if="canLogin" class="tw-hidden tw-fixed tw-top-0 tw-right-0 tw-px-6 tw-py-4 sm:tw-block">
            <Link v-if="$page.props.user" :href="route('dashboard')" class="tw-text-sm tw-text-gray-700 dark:tw-text-gray-500 tw-underline">Dashboard</Link>
                ...
                <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2">
                    <div class="tw-p-6">
                        <div class="tw-flex tw-items-center">
                            ...
                            <div class="tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold">
                                <a href="https://laravel.com/docs" class="tw-underline tw-text-gray-900 dark:tw-text-white">Documentation</a>
                            </div>
                        </div>
                    ...
                    <div class="tw-p-6 tw-border-t tw-border-gray-200 dark:tw-border-gray-700 md:tw-border-t-0 md:tw-border-l">
                        <div class="tw-flex tw-items-center">
                            ...
                            <div class="tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold">
                                <a href="https://laracasts.com" class="tw-underline tw-text-gray-900 dark:tw-text-white">Laracasts</a>
                            </div>
                        </div>
                    ...
                    <div class="tw-p-6 tw-border-t tw-border-gray-200 dark:tw-border-gray-700">
                        <div class="tw-flex tw-items-center">
                            ...
                            <div class="tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold">
                                <a href="https://laravel-news.com/" class="tw-underline tw-text-gray-900 dark:tw-text-white">Laravel News</a>
                            </div>
                        </div>
